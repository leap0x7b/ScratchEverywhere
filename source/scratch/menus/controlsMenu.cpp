...
void ControlsMenu::init() {
    ...
    backButton = new ButtonObject("", GFX_BUTTON_BACK, 375, 20, "gfx/menu/Ubuntu-Bold");
    applyButton = new ButtonObject("Apply (Y)", GFX_OPTION_BOX, 200, 230, "gfx/menu/Ubuntu-Bold");
    ...
    for (auto &control : controls) {
        key newControl;
        ButtonObject *controlButton = new ButtonObject(control, GFX_OPTION_BOX, 0, yPosition, "gfx/menu/Ubuntu-Bold");
